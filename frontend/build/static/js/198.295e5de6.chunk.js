(self.webpackChunkecom_frontend = self.webpackChunkecom_frontend || []).push([
  [198],
  {
    ...
    6411: (t, e, r) => {
      ...
      for (var p in n) g(i[p] && i[p].prototype, p);
      g(s, "DOMTokenList");
    },
    1198: (t, e, r) => {
      "use strict";
              ...
              if (
                ...
                if (0 === y)
                  ...
                  var v = (n.xRot * Math.PI) / 180,
                    ...
                    _ = Math.cos(M);
                  (n.rX =
                    Math.abs(y) / Math.sqrt(O * d(_) + P * N * _ + E * d(N))),
                    (n.rY =
                      Math.abs(y) / Math.sqrt(O * d(N) - P * N * _ + E * d(_))),
            ...
            (e.encode = function (t) {
              return (function (t) {
                ...
                for (var r = 0; r < t.length; r++) {
                  ...
                  else if (i.type === C.HORIZ_LINE_TO)
                    e += (i.relative ? "h" : "H") + i.x;
                  else if (i.type === C.VERT_LINE_TO)
                    e += (i.relative ? "v" : "V") + i.y;
                  else if (i.type === C.MOVE_TO)
                    e += (i.relative ? "m" : "M") + i.x + " " + i.y;
                  else if (i.type === C.LINE_TO)
      ...
      function V(t, e, r, i, n, s) {
        if (!(isNaN(s) || s < 1)) {
          ...
          (a = (function (t, e, r, i, n, s) {
            ...
            f.next = p;
            for (
              var y = null, v = null, m = 0, x = 0, b = M[s], S = N[s], w = 0;
              w < n;
              w++
            ) {
              f = p;
      ...
      class ut {
        ...
        getTextBaseline() {
          return this.hasValue()
            ? ut.textBaselineMapping[this.getString()]
            : null;
        }
        addOpacity(t) {
          for (
                ...
                (d = Date.now()),
                  (v = d - y) >= f &&
                    ...
                    this.shouldUpdate(i, o) &&
                      (this.render(t, n, s, h, u, l, c), p.runEvents())),
                  (this.intervalId = a(m));
              };
      ...
      class Pt {
        ...
        addChild(t) {
          ...
          (e.parent = this),
            Pt.ignoreChildTypes.includes(e.type) || this.children.push(e);
        }
        matchesSelector(t) {
          var e,
            { node: r } = this;
      ...
      class It extends Pt {
        ...
        setContext(t) {
          ...
          if (!e) {
            ...
            if (i.hasValue()) {
              var h = new ut(this.document, "fill", t.fillStyle)
                .addOpacity(i)
                .getColor();
              t.fillStyle = h;
            }
            ...
            if (s.hasValue()) {
              var c = new ut(this.document, "stroke", t.strokeStyle)
                .addOpacity(s)
                .getString();
              t.strokeStyle = c;
            }
      ...
      class Wt extends Pt {
        ...
        createPattern(t, e, r) {
          ...
          (s.attributes.viewBox = new ut(
            ...
            (s.attributes.width = new ut(
              this.document,
              "width",
              "".concat(i, "px"),
            )),
            (s.attributes.height = new ut(
              this.document,
              "height",
              "".concat(n, "px"),
            )),
      ...
      class Kt extends Pt {
        ...
        addParentOpacity(t, e) {
          return t.hasValue()
            ? new ut(this.document, "color", e).addOpacity(t).getColor()
            : e;
        }
      }
      class Jt extends Kt {
        ...
        renderChildren(t) {
          if (this.hasText) {
            ...
            n.isWorking() &&
              n.checkBoundingBox(
                this,
                new Rt(r, i - s.getPixels("y"), r + this.measureText(t), i),
              );
      ...
      class ge extends Bt {
        ...
        getPointOnQuadraticBezier(t, e, r, i, n, s, a) {
          return {
            x: s * at(t) + i * ot(t) + e * ht(t),
            y: a * at(t) + n * ot(t) + r * ht(t),
          };
        }
        ...
        renderChildren(t) {
          ...
          if (r) {
            ...
            if (
              ...
              n.hasValue() &&
                (i.attributes.width = new ut(e, "width", n.getString())),
                s.hasValue() &&
                  (i.attributes.height = new ut(e, "height", s.getString()));
            }
            var a = i.parent;
      ...
      class Fe {
        constructor(t, e) {
          var r =
            arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {};
          (this.parser = new mt(r)),
            (this.screen = new dt(t, r)),
            (this.options = r);
          var i = new De(this, r),
        ...
        render() {
          ...
          return n(function* () {
            ...
            e.start(
              ze({ enableRedraw: !0, ignoreAnimation: !0, ignoreMouse: !0 }, r),
            ),
              yield e.ready(),
              e.stop();
          })();
...
//# sourceMappingURL=198.295e5de6.chunk.js.map
