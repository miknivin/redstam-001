        ...
        >
          ...
          >
            ...
            <Link
              ...
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-gray-900 border border-gray-700  rounded-lg hover:bg-gray-800 hover:text-gray-100 focus:ring-4 focus:ring-gray-100 dark:border-gray-900"
            >
              Know more
            </Link>
          </motion.div>
