    ...
    <section className="bg-transparent">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        >
          <motion.h1
            variants={item}
            className="max-w-2xl mb-2 text-4xl font-light tracking-tight leading-none text-gray-900 md:text-5xl xl:text-5xl dark:text-white"
          >
            {product.name}
          </motion.h1>
          ...
          <motion.p
            variants={item}
            className="max-w-2xl mb-6 font-light text-gray-900 dark:text-gray-100 lg:mb-8 md:text-lg  line-clamp-[8]"
          >
            {product.description}
          </motion.p>
