  ...
  return (
    <>
      <div className=" p-10">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              'We', 'Us' or 'Our' in this Agreement) refers to {/* */}GENFOR
              GLOBAL PRIVATE LIMITED{/* */}, {/* */}37/3489 - FIFTH FLOOR,
              MANJOORAN ESTATE, EDAPPALLY {/* */}.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to {/* */}GENFOR GLOBAL PRIVATE
              LIMITED
              {/* */}, accessible from{/* */}{" "}
              <a
                href="https://redstam.com"
        ...
        <ul>
          <li>By email: {/* */}info@redstam.com</li>
        </ul>
      </div>
    </>
  );
