    ...
    <div className="p-8 bg-gray-950">
      <>
        ...
        <p>
          ...
          use of {/* */}Genfor Global Pvt Ltd{/* */}'s Website, located at{" "}
          {/* */}redstam.com
          {/* */}.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use {/* */}redstam.com{/* */} if you do
        ...
        <p>
          We employ the use of cookies. By accessing {/* */}redstam.com{/* */},
          you agreed to use cookies in agreement with the {/* */}Genfor Global
          pvt ltd
          {/* */}'s Privacy Policy.{/* */}{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, {/* */}Genfor Global pvt ltd{/* */} and/or
          its licensors own the intellectual property rights for all material on{" "}
          {/* */}
          redstam.com{/* */}. All intellectual property rights are reserved. You
          may access this from {/* */}redstam.com{/* */} for your own personal
          use subjected to restrictions set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from {/* */}redstam.com</li>
          <li>Sell, rent or sub-license material from {/* */}redstam.com</li>
          <li>Reproduce, duplicate or copy material from {/* */}redstam.com</li>
          <li>Redistribute content from {/* */}redstam.com</li>
        </ul>
        <p>
          Parts of this website offer an opportunity for users to post and
          exchange opinions and information in certain areas of the website.{" "}
          {/* */}Genfor Global pvt ltd{/* */}does not filter, edit, publish or
          review Comments prior to their presence on the website. Comments do
          not reflect the views and opinions of{/* */}Genfor Global pvt ltd
          ...
          extent permitted by applicable laws, {/* */}Genfor Global pvt ltd
        ...
        <p>
          Genfor Global pvt ltd{/* */} reserves the right to monitor all
        ...
        <p>
          You hereby grant {/* */}Genfor Global pvt ltd{/* */} a non-exclusive
        ...
        <ul className="type-alpha">
          ...
          <li>
            ...
            the absence of {/* */}Genfor Global Pvt Ltd{/* */}; and
          </li>
        ...
        <p>
          ...
          sending an e-mail to {/* */}Genfor Global pvt ltd{/* */}. Please
        ...
        <p>
          No use of {/* */}Genfor Global pvt ltd{/* */}'s logo or other artwork
